...
export default function CTASection() {
  return (
    <section className='bg-[#020617] text-center py-16 px-6'>
      ...
      {/* Features Row */}
      <div className='flex flex-wrap justify-center items-center gap-6 mt-6 text-gray-200'>
      ...
      <div className='mt-8 flex flex-col md:flex-row justify-center gap-4'>
        <Button className='bg-green-600 hover:bg-green-700 text-white text-lg px-6 py-5 rounded-lg'>
