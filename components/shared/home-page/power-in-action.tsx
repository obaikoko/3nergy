      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg max-w-3xl mx-auto">
            Explore our completed solar installations and products in action.
            See how Cesol3nergy is bringing reliable, affordable energy to
            homes, businesses, and estates across Nigeria.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
          {installations[activeTab as keyof typeof installations].map(
            (installation, index) => (
              <div
                key={index}
        ...
        <div className="text-center mt-12">
          ...
          <p className="text-lg mb-6">
            Pick a package, request a quote, and let&apos;s power your future
            together.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              ...
              href="https://wa.me/2349066996674?text=Hello%20there!"
            >
              WhatsApp Us: +2349066996674
            </Link>
          </div>
          <p className="text-sm text-gray-500 mt-4">
            No upfront risk • Clear package pricing with no hidden costs • Once
            payment is confirmed, your solar setup is installed fast — within 2
            days on selected packages.
          </p>
        </div>
      </div>
    </section>
